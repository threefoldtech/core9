...
from JumpScale9.data.key_value_store.fs_store import FileSystemKeyValueStore
from JumpScale9.data.key_value_store.memory_store import MemoryKeyValueStore
from js9 import j
from JumpScale9.data.key_value_store.store import KeyValueStoreType

if not q._init_called:
    from JumpScale9.core.InitBase import q
